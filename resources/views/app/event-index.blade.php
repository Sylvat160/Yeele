                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools dropdown">
                            <button class="bg-transparent border-0" type="button" id="event_menu" data-toggle="dropdown"
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        <img src="{{ asset('images/illustrations/empty.svg') }}" width="200"
                            alt="Aucun évènement enregistré">
                    </div>
