        ...
        <div class="bg-white w-11/12 rounded-lg border border-gray-200 shadow-sm" style="max-width: 500px;">
            ...
            <div class="my-4">
                <form action="{{ route('app.login') }}" method="POST">
                    ...
                    <div class="px-4 flex items-start mb-6">
                        <div class="flex items-center h-5">
                          <input id="remember" type="checkbox" name="remember" value="1" class="w-4 h-4 checked:bg-red-500 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-red-300">
                        </div>
