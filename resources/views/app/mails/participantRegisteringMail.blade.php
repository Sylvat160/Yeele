...
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-left: 48px; padding-top: 33px; padding-bottom: 0px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" style="line-height:10px"><img alt="Logo de Yeele" src="{{ $message->embed(URL::to('/') . '/public/logo.png') }}" style="display: block; height: auto; border: 0; width: 148px; max-width: 100%;" title="I'm an image" width="148"/></div>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="font-size:28px;">Votre inscription à l'évènement {{ $participant->event->name }} a été un succès!</span></p>
</div>
</div>
</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
<tr>
<td style="padding-bottom:10px;padding-left:38px;padding-right:38px;padding-top:10px;">
<div style="font-family: 'Karla', sans-serif">
<div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: 'Karla', sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
<p style="margin: 0; text-align: center; mso-line-height-alt: 24px;"><span style="font-size:16px;color:#2a272b;">Ci-dessous vos informations: </span></p>
<table
        style="width: 320px; border: .5px solid #ddd; margin: 10px auto; font-family: 'Karla', sans-serif;">
        <thead style="background: #f8f8f8; padding: 5px auto;">
            <th colspan="2" style="text-align: center; padding: 5px;">Vos informations d'inscription</th>
        </thead>
        <tbody style="border: .1px solid #ddd;">
            ...
            @endisset
            @if($participant->event->multiple_prices_active)
                @isset($participant->participantPrices)
                        <tr style="padding: 5px auto;">
                            <td style="font-weight: bold;">Tarifs choisis</td>
                            <td>
                                @foreach($participant->participantPrices as $price)
                                    <div>
                                        {{ $price->eventPrice->label . "(" . $price->eventPrice->value . " FCFA)" }}
                                        {{ isset($price->quantity) ? "(" . isset($price->quantity) . ")" : "" }}
                                    </div>
                                @endforeach
                            </td>
                        </tr>
...
<div style="width: 75%; margin: 10px auto; font-family: 'Karla', sans-serif">
    <p style="font-size: 16px; text-align: center;">Pour toute modification des données ou d'annulation de votre inscription, cliquez sur ce lien: <a href="{{ $link }}">Modifier ses données</a> ou contactez nous par email: <a href="infos@yeele-event.com">infos@yeele-event.com</a> ou par WhatsApp sur <a href="https://wa.me/message/WNOTNFPLUAQKN1">+226 61 60 15 15</a>.</p>
...
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-left: 48px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="33.333333333333336%">
<table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td style="width:100%;padding-right:0px;padding-left:0px;padding-top:33px;">
<div style="line-height:10px"><img alt="I'm an image" src="{{ $message->embed(URL::to('/') . '/public/logo.png') }}" style="display: block; height: auto; border: 0; width: 74px; max-width: 100%;" title="I'm an image" width="74"/></div>
</td>
</tr>
</table>
</td>
...
<table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
<tr>
<td style="padding-bottom:33px;padding-right:48px;">
<div style="font-family: 'Karla', sans-serif">
<div class="txtTinyMce-wrapper" style="font-size: 12px; font-family: 'Karla', Arial, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
<p style="margin: 0; font-size: 14px; text-align: left;">Copyright © 2022</p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 0px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
<table border="0" cellpadding="15" cellspacing="0" class="divider_block mobile_hide" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td>
<div align="center">
<table border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
