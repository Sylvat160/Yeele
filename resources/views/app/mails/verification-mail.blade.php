...
<p style="margin: 0; font-size: 16px; text-align: center;"><span style="color:#000000;font-size:24px;"><strong>Bonjour {{ "$user->firstname $user->lastname" }}!</strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; text-align: center; mso-line-height-alt: 24px;"><span style="font-size:16px;color:#2a272b;">Pour pouvoir vous connecter, veuillez d'abord valider votre adresse e-mail en cliquant sur le lien ci-dessous: 👇🏿</span></p>
