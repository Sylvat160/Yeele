...
<body>
    ...
    <div class="w-100 min-h-screen py-4 bg-gray-100/2">
        <div class="bg-slate-100 w-11/12 rounded-lg border border-gray-200 shadow-sm mx-auto" style="max-width: 550px; @if ($event->bg_color !== '#000000') background: {{ $event->bg_color }} @endif; color: {{ $event->text_color }};">
            ...
            @endif
            <form class="px-4 py-8" action="{{ route('participant.payment.update') }}" method="POST" data-participant-additional-data="{{ $participant->additional_data }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="civility" id="civility" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="lastname" id="lastname" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" placeholder="ex: Traoré, Diallo" value="{{ $participant->lastname }}" required>
                    @error('lastname')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="firstname" id="firstname" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" placeholder="ex: Samuel, Issouf" value="{{ $participant->firstname }}" required>
                    @error('firstname')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}
                    </p>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" id="email" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" placeholder="ex: exemple@gmail.com" value="{{ $participant->email }}" required>
                    @error('email')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" name="phone" id="phone" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" placeholder="ex: (+226) XXXXXXXX" value="{{ $participant->phone }}" required>
                    @error('phone')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    @endif
                    <button id="prices_btn" data-dropdown-toggle="prices" data-dropdown-placement="bottom" class="bg-gray-50 inline-flex items-center justify-between outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 w-full p-2.5" type="button">Choisissez vos tarifs <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @else
                    <select name="price" id="price" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required>
                ...
                <div>
                    ...
                    <select name="field_uid" id="field_uid" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required>
                ...
                <div class="mb-3">
                    ...
                    @endisset
                    <select name="{{ $field['name'] }}" id="{{ $field['name'] }}" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" @if($field['required']) required @endif>
                ...
                <div class="mb-3">
                    ...
                    @endisset
                    <input type="{{ $field['subtype'] }}" name="{{ $field['name'] }}" id="{{ $field['name'] }}" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" @isset($field['placeholder']) placeholder="{{ $field['placeholder'] }}" @endisset @isset($field['value']) value="{{ $field['value'] }}" @endisset @if($field['required']) required @endif>
                </div>
                @break
                ...
                <div class="mb-3">
                    ...
                    @endisset
                    <input type="number" @isset($field['min']) min="{{ $field['min'] }}" @endisset @isset($field['max']) min="{{ $field['max'] }}" @endisset name="{{ $field['name'] }}" id="{{ $field['name'] }}" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" @isset($field['placeholder']) placeholder="{{ $field['placeholder'] }}" @endisset @isset($field['value']) value="{{ $field['value'] }}" @endisset @if($field['required']) required @endif>
                </div>
                @break
                ...
                <div class="mb-3">
                    <label for="references" class="block mb-2 text-sm font-semibold text-gray-900">
                        <span>References de paiement</span>
                        <span class="text-red-600">*</span>
                    </label>
                    <textarea name="references" id="references" class="bg-gray-50 outline-none transition-colors border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-1 focus:ring-red-500 focus:border-red-500 block w-full p-2.5" col="4" rows="5" required></textarea>
                    @error('references')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-8">
                    <button type="submit" class="text-white bg-red-500 focus:bg-red-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center mx-auto" style="width: fit-content;">
