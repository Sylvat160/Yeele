    ...
    <div class="w-100 min-h-screen py-4 sm:py-0 bg-gray-100 flex justify-center items-center">
        <div class="bg-white w-11/12 rounded-lg border border-gray-200 shadow-sm" style="max-width: 500px;">
            ...
            <div class="py-2 text-center">
                <a href="#" class="text-red-500 hover:text-red-600 font-semibold block">Mot de passe oublié?</a>
                <span>ou</span>
                <a href="#" class="text-red-500 hover:text-red-600 font-semibold block">S'inscrire</a>
            </div>
        </div>
    </div>
