...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::to('/') . '/public/favicon.png' }}" type="image/png">
...
<body>
    <div class="w-100 min-h-screen py-4 bg-gray-100/2">
        <div class="pt-4 pb-8">
            <img src="{{ URL::to('/') . '/public/logo.png' }}" alt="Yeele" class="w-32 mx-auto">
        </div>
        <div class="bg-slate-100 w-11/12 rounded-lg border border-gray-200 shadow-sm mx-auto"
            ...
            <div class="px-4 border-b">
                <img src="{{ URL::to('/') . '/public/storage/' . $event->image }}" width="400" height="600"
