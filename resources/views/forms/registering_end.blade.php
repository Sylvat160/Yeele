...
<body>
    ...
    <div class="w-full min-h-screen py-4 sm:py-0 bg-gray-100 flex justify-center items-center">
        <div class="bg-white w-11/12 rounded-lg border border-gray-200 shadow-sm" style="max-width: 750px;">
            ...
            <div class="my-4 px-4">
                <p class="text-md text-center">Votre inscription de participation à l'évènement <strong>{{ $event->name }}</strong> a été un succès. Un mail contenant vos information vous a été envoyé.</p>
            </div>
            <div class="mt-6 mb-8">
