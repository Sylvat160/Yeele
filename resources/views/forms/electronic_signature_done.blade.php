...
<body>
    <div class="w-full min-h-screen py-4 sm:py-0 bg-gray-100 flex flex-col justify-center items-center">
        ...
        <div class="bg-white w-11/12 rounded-lg border border-gray-200 shadow-sm" style="max-width: 500px;">
            <div class="py-2">
                <img src="{{ asset('images/illustrations/mail_sent.svg') }}" alt="Formulaire envoyé" class="w-48 mx-auto">
            </div>
            <div class="mb-2">
                <h1 class="text-xl text-center font-bold">Formulaire envoyé!</h1>
            </div>
            <div class="my-4 px-4">
                <p class="text-md text-center">Vos reponses au questionnaire sur <strong>la signature électronique</strong> ont été envoyées avec succès. Merci.</p>
            </div>
