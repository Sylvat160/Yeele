...
@section('content')
    <div class="my-12">
        ...
        <x-website-container class="my-10">
            ...
            <div>
                <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
                    <b>www.yeele-event.com</b> (together or individually “Service”) operated by <b>HORINFO</b>.
                </p>
                ...
                <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please
                    let
                    us know by emailing at <b>infos@yeele-event.com</b> so we can try to find a solution. These Terms apply
                    to
                    all visitors, users and others who wish to access or use Service.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">2. Communications</h1>
            <div>
                <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other
                    ...
                    us by following the unsubscribe link or by emailing at infos@yeele-event.com.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">3. Purchases</h1>
            <div>
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">4. Contests, Sweepstakes and Promotions</h1>
            <div>
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">5. Subscriptions</h1>
            <div>
                <p>Any contests, sweepstakes or other promotions (collectively, “Promotions”) made available through Service
                    may be governed by rules that are separate from these Terms of Service. If you participate in any
                    Promotions, please review the applicable rules as well as our Privacy Policy. If the rules for a
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">6. Free Trial</h1>
            <div>
                <p>HORINFO may, at its sole discretion, offer a Subscription with a free trial for a limited period of time
                    ("Free
                    Trial").</p>
                <p>You may be required to enter your billing information in order to sign up for Free Trial.</p>
                <p>If you do enter your billing information when signing up for Free Trial, you will not be charged by
                    HORINFO until
                    Free Trial has expired. On the last day of Free Trial period, unless you cancelled your Subscription,
                    you will be
                    automatically charged the applicable Subscription fees for the type of Subscription you have selected.
                </p>
                <p>At any time and without notice, HORINFO reserves the right to (i) modify Terms of Service of Free Trial
                    offer, or
                    (ii) cancel such Free Trial offer.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">7. Fee Changes</h1>
            <div>
                <p>HORINFO, in its sole discretion and at any time, may modify Subscription fees for the Subscriptions. Any
                    Subscription
                    fee change will become effective at the end of the then-current Billing Cycle.</p>
                <p>HORINFO will provide you with a reasonable prior notice of any change in Subscription fees to give you an
                    opportunity
                    to terminate your Subscription before such change becomes effective.</p>
                <p>Your continued use of Service after Subscription fee change comes into effect constitutes your agreement
                    to pay the
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">8. Refunds</h1>
            <div>
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">9. Content</h1>
            <div>
                <p>Our Service allows you to post, link, store, share and otherwise make available certain information,
                    text, graphics,
                    videos, or other material (“Content”). You are responsible for Content that you post on or through
                    Service,
                    including its legality, reliability, and appropriateness.</p>
                <p>By posting Content on or through Service, You represent and warrant that: (i) Content is yours (you own
                    it) and/or
                    you have the right to use it and the right to grant us the rights and license as provided in these
                    Terms, and (ii)
                    that the posting of your Content on or through Service does not violate the privacy rights, publicity
                    rights,
                    copyrights, contract rights or any other rights of any person or entity. We reserve the right to
                    terminate the
                    account of anyone found to be infringing on a copyright.</p>
                <p>You retain any and all of your rights to any Content you submit, post or display on or through Service
                    and you are
                    responsible for protecting those rights. We take no responsibility and assume no liability for Content
                    you or any
                    third party posts on or through Service. However, by posting Content using Service you grant us the
                    right and
                    license to use, modify, publicly perform, publicly display, reproduce, and distribute such Content on
                    and through
                    Service. You agree that this license includes the right for us to make your Content available to other
                    users of
                    Service, who may also use your Content subject to these Terms.</p>
                <p>HORINFO has the right but not the obligation to monitor and edit all Content provided by users.</p>
                <p>In addition, Content found on or through this Service are the property of HORINFO or used with
                    permission. You may
                    not distribute, modify, transmit, reuse, download, repost, copy, or use said Content, whether in whole
                    or in part,
                    for commercial purposes or for personal gain, without express advance written permission from us.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">10. Prohibited Uses</h1>
            <div>
                ...
                <p>0.3. To transmit, or procure the sending of, any advertising or promotional material, including any “junk
                    mail”,
                    “chain letter,” “spam,” or any other similar solicitation.</p>
                ...
                <p>0.6. To engage in any other conduct that restricts or inhibits anyone’s use or enjoyment of Service, or
                    which, as
                    determined by us, may harm or offend Company or users of Service or expose them to liability.</p>
                <p>Additionally, you agree not to:</p>
                <p>0.1. Use Service in any manner that could disable, overburden, damage, or impair Service or interfere
                    with any other
                    party’s use of Service, including their ability to engage in real time activities through Service.</p>
                <p>0.2. Use any robot, spider, or other automatic device, process, or means to access Service for any
                    purpose, including
                    monitoring or copying any of the material on Service.</p>
                ...
                <p>0.6. Attempt to gain unauthorized access to, interfere with, damage, or disrupt any parts of Service, the
                    server on
                    which Service is stored, or any server, computer, or database connected to Service.</p>
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">11. Analytics</h1>
            <div>
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">12. No Use By Minors</h1>
            <div>
                <p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
                <p>Service is intended only for access and use by individuals at least eighteen (18) years old. By accessing
                    or using
                    Service, you warrant and represent that you are at least eighteen (18) years of age and with the full
                    authority,
                    right, and capacity to enter into this agreement and abide by all of the terms and conditions of Terms.
                    If you are
                    not at least eighteen (18) years old, you are prohibited from both the access and usage of Service.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">13. Accounts</h1>
            <div>
                <p>When you create an account with us, you guarantee that you are above the age of 18, and that the
                    information you
                    provide us is accurate, complete, and current at all times. Inaccurate, incomplete, or obsolete
                    information may
                    result in the immediate termination of your account on Service.</p>
                <p>You are responsible for maintaining the confidentiality of your account and password, including but not
                    limited to
                    the restriction of access to your computer and/or account. You agree to accept responsibility for any
                    and all
                    activities or actions that occur under your account and/or password, whether your password is with our
                    Service or a
                    third-party service. You must notify us immediately upon becoming aware of any breach of security or
                    unauthorized
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">14. Intellectual Property</h1>
            <div>
                <p>Service and its original content (excluding Content provided by users), features and functionality are
                    and will
                    remain the exclusive property of HORINFO and its licensors. Service is protected by copyright,
                    trademark, and other
                    laws of and foreign countries. Our trademarks may not be used in connection with any product or service
                    without the
                    prior written consent of HORINFO.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">15. Copyright Policy</h1>
            <div>
                <p>We respect the intellectual property rights of others. It is our policy to respond to any claim that
                    Content posted
                    on Service infringes on the copyright or other intellectual property rights (“Infringement”) of any
                    person or
                    entity.</p>
                <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work
                    ...
                    infos@yeele-event.com, with the subject line: “Copyright Infringement” and include in your claim a
                    detailed
                ...
                <p>You may be held accountable for damages (including costs and attorneys’ fees) for misrepresentation or
                    bad-faith
                    claims on the infringement of any Content found on and/or through Service on your copyright.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">16. DMCA Notice and Procedure for Copyright Infringement
                Claims</h1>
            <div>
                ...
                <p>0.2. a description of the copyrighted work that you claim has been infringed, including the URL (i.e.,
                    web page
                    address) of the location where the copyrighted work exists or a copy of the copyrighted work;</p>
                ...
                <p>You can contact our Copyright Agent via email at infos@yeele-event.com.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">17. Error Reporting and Feedback</h1>
            <div>
                <p>You may provide us either directly at infos@yeele-event.com or via third party sites and tools with
                    information and
                    feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters
                    related to
                    our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert
                    any
                    intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may
                    have
                    development ideas similar to the Feedback; (iii) Feedback does not contain confidential information or
                    proprietary
                    information from you or any third party; and (iv) Company is not under any obligation of confidentiality
                    with
                    respect to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due
                    to
                    ...
                    derivative
                    works, publish, distribute and commercialize) Feedback in any manner and for any purpose.</p>

            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">18. Links To Other Web Sites</h1>
            <div>
                <p>Our Service may contain links to third party web sites or services that are not owned or controlled by
                    HORINFO.</p>
                <p>HORINFO has no control over, and assumes no responsibility for the content, privacy policies, or
                    practices of any
                    third party web sites or services. We do not warrant the offerings of any of these entities/individuals
                    or their
                    websites.</p>
                <p>For example, the outlined <a href="https://policymaker.io/terms-and-conditions/">Terms of Use</a> have
                    ...
                    high-quality legal
                    documents. PolicyMaker’s <a href="https://policymaker.io/terms-and-conditions/">Terms and Conditions
                        generator</a>
                    is an easy-to-use free tool for creating an excellent standard Terms of Service template for a website,
                    blog,
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">19. Disclaimer Of Warranty</h1>
            <div>
                <p>THESE SERVICES ARE PROVIDED BY COMPANY ON AN “AS IS” AND “AS AVAILABLE” BASIS. COMPANY MAKES NO REPRESENTATIONS OR
                    ...
                    ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK.</p>
                <p>NEITHER COMPANY NOR ANY PERSON ASSOCIATED WITH COMPANY MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE
                ...
                <p>COMPANY HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING
                    BUT NOT LIMITED TO ANY WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, AND FITNESS FOR PARTICULAR PURPOSE.</p>
                <p>THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.</p>                
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">20. Limitation Of Liability</h1>
            <div>
                <p>EXCEPT AS PROHIBITED BY LAW, YOU WILL HOLD US AND OUR OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS HARMLESS FOR ANY
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">21. Termination</h1>
            <div>
        ...
        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">22. Governing Law</h1>
            <div>
                <p>These Terms shall be governed and construed in accordance with the laws of BURKINA FASO, which governing law applies
                    to agreement without regard to its conflict of law provisions.</p>
                <p>Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights. If any
                    ...
                    and replace any prior agreements we might have had between us regarding Service.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">23. Changes To Service</h1>
            <div>
                <p>We reserve the right to withdraw or amend our Service, and any service or material we provide via Service, in our
                    ...
                    Service, to users, including registered users.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">24. Amendments To Terms</h1>
            <div>
                <p>We may amend Terms at any time by posting the amended terms on this site. It is your responsibility to review these
                    Terms periodically.</p>
                ...
                <p>By continuing to access or use our Service after any revisions become effective, you agree to be bound by the revised
                    terms. If you do not agree to the new terms, you are no longer authorized to use Service.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">25. Waiver And Severability</h1>
            <div>
                <p>No waiver by Company of any term or condition set forth in Terms shall be deemed a further or continuing waiver of
                    such term or condition or a waiver of any other term or condition, and any failure of Company to assert a right or
                    provision under Terms shall not constitute a waiver of such right or provision.</p>
                <p>If any provision of Terms is held by a court or other tribunal of competent jurisdiction to be invalid, illegal or
                    unenforceable for any reason, such provision shall be eliminated or limited to the minimum extent such that the
                    remaining provisions of Terms will continue in full force and effect.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">26. Acknowledgement</h1>
            <div>
                <p>BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE AND
                    AGREE TO BE BOUND BY THEM.</p>
            </div>
        </x-website-container>

        <x-website-container class="my-10">
            <h1 class="montserrat_bold" style="font-size: 30px;">27. Contact Us</h1>
            <div>
                <p>Please send your feedback, comments, requests for technical support by email: <b>infos@yeele-event.com</b>.</p>
                <p style="margin-top: 5em; font-size: 0.7em;">These <a href="https://policymaker.io/terms-and-conditions/">Terms of
                        Service</a> were created for <b>www.yeele-event.com</b> by <a href="https://policymaker.io">PolicyMaker.io</a>
                    on 2022-04-09.</p>
            </div>
        </x-website-container>
    </div>
