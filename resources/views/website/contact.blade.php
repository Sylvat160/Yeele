        ...
        <x-website-container class="grid gap-6 md:gap-12 grid-cols-1 md:grid-cols-2">
            <div>
                ...
                <h5 class="mt-4 text-2xl text-center md:text-left sm:text-2xl lg:text-3xl font-semibold">
                    Des <span class="text-red-500 font-semibold">questions</span>? <span class="text-red-500 font-semibold">Un commentaire</span>? Ou voudrez-vous juste entrer en contact avec nous? ecrivez-nous <span class="hidden md:inline">👉🏽</span>!
                </h5>
                <div class="mt-6">
                ...
                <div class="p-4 rounded-lg border border-gray-200 shadow-md sm:p-6">
                    <form class="space-y-6" action="#">
                        <div class="grid gap-4 grid-cols-1 md:grid-cols-2">
                            ...
                            <div class="col-span-2 md:col-auto">
                                <label for="subject" class="block mb-2 text-sm font-semibold text-gray-900">Object: </label>
