            ...
            <div class="row mt-1">
                <div class="col-sm-12">
                    <table id="usersData" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                        <thead>
                            <tr>
                                <th class="sorting" tabindex="0" aria-controls="Plan" rowspan="1" colspan="1" aria-sort="Plan" aria-label="Plan: activate to sort column descending">Formule
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="Duration" rowspan="1" colspan="1" aria-label="Duration: activate to sort column ascending">Durée</th>
                                <th class="sorting" tabindex="0" aria-controls="Price" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending">Montant</th>
                                <th class="sorting" tabindex="0" aria-controls="Payment_method" rowspan="1" colspan="1" aria-label="Payment_method: activate to sort column ascending">Mode de paiement</th>
                                <th class="sorting" tabindex="0" aria-controls="Status" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending">Statut</th>
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="Start_date" rowspan="1" colspan="1" aria-label="Start_date: activate to sort column ascending">Date de début</th>
                                <th>Date de fin</th>
