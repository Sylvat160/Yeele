...
<div class="row @if ($events->count() < 2) justify-content-center @endif">
    @forelse($events->sortDesc() as $event)
    ...
    <div class="col-12 col-md-6">
        <div class="card">
            ...
            <div class="card-footer bg-white">
                <h5 class="text-center"> Aucun évènement.</h5>
