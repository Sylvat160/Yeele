...
/***/ "./resources/js/additional-validator.js":
/*!**********************************************!*\
  !*** ./resources/js/additional-validator.js ***!
  \**********************************************/
/***/ ((module) => {
...
function checkboxValidator() {
  var state = {
    value: [],
    setState: function setState(newValue, eventName) {
      this.value = newValue;
      window.dispatchEvent(new Event(eventName));
    }
  };
  var checkboxgroups = document.querySelectorAll('.is-checkbox-group');
  checkboxgroups.forEach(function (container) {
    var newEventName = "checkbox".concat(new Date().getTime());
    ...
    var values = checkedInputs.map(function (ci) {
...
__webpack_require__(/*! ./additional-validator */ "./resources/js/additional-validator.js")();
...
var payment = function payment() {
  ...
  if (priceSelect) {
    priceSelect.addEventListener("change", function () {
      ...
      Array.from(registrationForm.querySelectorAll("input")).forEach(function (input) {
  ...
  if (paymentContainer) {
    ...
    registrationForm.addEventListener("submit", function (e) {
      ...
      if (directPayments.includes(paymentMethod.value) && Number(paymentStatus.value) === 0) {
        e.preventDefault();
        document.getElementById("pm_error").innerText = "Vous n'avez pas éffectué le paiement.";
      }
    });
  }
};
